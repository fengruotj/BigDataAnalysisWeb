...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <#--sentencesTopology-->
            <div class="sentencesTopology">
                <div class="row">
                    <div class="m-heading-1 border-green m-bordered">
                        <h3>SentenceWordCountTopology</h3>
                        <p> 这是一个对StormWordCount进行benchmark测试。数据源是自己创造的句子集合不停的发送单词（目的为了测试Strom的极限吞吐量）
                        </p>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="portlet box purple ">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i> 配置程序的并行度参数 </div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <form role="form">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                    <span class="input-group-btn">
                                                        <button class="btn red" type="button">worker进程</button>
                                                    </span>
                                                <input id="sentencesworkernum" type="number" class="form-control"> </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-3 -->
                                        <div class="col-md-4">
                                            <div class="input-group">
                                         <span class="input-group-btn">
                                                        <button class="btn blue" type="button">spout并行度</button>
                                                    </span>
                                                <input id="sentencespoutnum" type="number" class="form-control">
                                            </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-3 -->
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <span class="input-group-btn">
                                                ...
                                                <input id="sentenceswordcountnum" type="number" class="form-control">
                                            </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-4 -->
                                ...
                                <div class="form-actions noborder">
                                    <button onclick="sentencesubmit()" type="button" class="btn blue"><span class="md-click-circle md-click-animate" style="height: 73px; width: 73px; top: -11.5px; left: -5.5px;"></span>Submit</button>
                                    <button onclick="sentencescancel()" type="button" class="btn default">Cancel</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <#--socketTopology-->
            <div class="socketTopology">
                <div class="row">
                    <div class="m-heading-1 border-green m-bordered">
                        <h3>SocketWordCountTopology</h3>
                        <p> 这是一个对StormWordCount进行benchmark测试。数据源是Socket管道通信，可能有网络瓶颈。Linux nc -lk 命令< 文件.txt 写入Socket管道中 文件是resultTweets.txt 3.23GB
                        </p>
                    </div>
                </div>
                    ...
                    <div class="portlet box purple ">
                        ...
                        <div class="portlet-body">
                            ...
                            <form role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input id="socketworkernum" type="number" class="form-control"> </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-3 -->
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <span class="input-group-btn">
                                                ...
                                                <input id="socketwordcountnum" type="number" class="form-control">
                                            </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-4 -->
                                ...
                                <br/>
                                <div class="form-actions noborder">
                                    <button onclick="socketsubmit()" type="button" class="btn blue"><span class="md-click-circle md-click-animate" style="height: 73px; width: 73px; top: -11.5px; left: -5.5px;"></span>Submit</button>
                                    <button onclick="socketcancel()" type="button" class="btn default">Cancel</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <#--kafkaTopology-->
            <div class="kafkaTopology">
                <div class="row">
                    <div class="m-heading-1 border-green m-bordered">
                        <h3>KafkaWordCountTopology</h3>
                        <p> 这是一个对StormWordCount进行benchmark测试。数据源是kafka集群中 事先已经囤积好的数据消息（估计消息大概有7亿条）
                        </p>
                    </div>
                </div>
                    ...
                    <div class="portlet box purple ">
                        ...
                        <div class="portlet-body">
                            ...
                            <form role="form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input id="kafkatopic" type="TEXT" class="form-control"> </div>
                                            <!-- /input-group -->
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group">
                                                ...
                                                <input id="kafkaworkernum" type="number" class="form-control"> </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-3 -->
                                        <div class="col-md-3">
                                         ...
                                         <span class="input-group-btn">
                                                ...
                                                <input id="kafkaspoutnum" type="number" class="form-control">
                                            </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-3 -->
                                ...
                                <br/>
                                <div class="form-actions noborder">
                                    <button onclick="kafkasubmit()" type="button" class="btn blue"><span class="md-click-circle md-click-animate" style="height: 73px; width: 73px; top: -11.5px; left: -5.5px;"></span>Submit</button>
                                    <button onclick="kafkacancel()" type="button" class="btn default">Cancel</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <#--hdfsTopology-->
            <div class="hdfsTopology">
                <div class="row">
                    <div class="m-heading-1 border-green m-bordered">
                        <h3>HdfsBenchMarkTopology</h3>
                        <p> 这是一个对Storm-hdfs进行benchmark测试。数据源是Hdfs文件系统 Storm读取Hdfs文件系统上的数据 每个文件是resultTweets.txt 3.23GB
                        </p>
                    </div>
                </div>
                    ...
                    <div class="portlet box purple ">
                        ...
                        <div class="portlet-body">
                            ...
                            <form role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="input-group">
                                                ...
                                                <input id="hdfsworkernum" type="number" class="form-control"> </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-3 -->
                                        <div class="col-md-4">
                                         ...
                                         <span class="input-group-btn">
                                                ...
                                                <input id="hdfsspoutnum" type="number" class="form-control">
                                            </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-3 -->
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group">
                                          <span class="input-group-btn">
                                                        <button class="btn blue" type="button">computebolt并行度</button>
                                                    </span>
                                                <input id="hdfscomputenum" type="number" class="form-control">
                                            </div>
                                            <!-- /input-group -->
                                        </div>
                                        <!-- /.col-md-4 -->
                                ...
                                <br/>
                                <div class="form-actions noborder">
                                    <button onclick="hdfssubmit()" type="button" class="btn blue"><span class="md-click-circle md-click-animate" style="height: 73px; width: 73px; top: -11.5px; left: -5.5px;"></span>Submit</button>
                                    <button onclick="hdfscancel()" type="button" class="btn default">Cancel</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function sentencesubmit(){
        alert("senteces-submit click");
    }

    function sentencescancel(){
        alert("senteces-cancel click");
    }


    function socketsubmit(){
        alert("socket-submit click");
    }

    function socketcancel(){
        alert("socekt-cancel click");
    }

    function kafkasubmit(){
        alert("kafka-submit click");
    }

    function kafkacancel(){
        alert("kafka-cancel click");
    }

    function hdfssubmit(){
        alert("hdfs-submit click");
    }

    function hdfscancel(){
        alert("hdfs-cancel click");
    }
