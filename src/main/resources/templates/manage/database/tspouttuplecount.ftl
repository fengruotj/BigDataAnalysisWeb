...
//                  userName : ''
  ...
  <body>
      <table id="dg" title="t_spouttuplecount表数据" class="easyui-datagrid"
             url="/spouttuplecount/queryByPage"
             toolbar="#toolbar"
             pagination= true
             striped=true
             nowrap=true
          ...
          <tr>
              ...
              <th field="tuplecount" formatter="countformatter" width="20">当前流过的数据量</th>
          </tr>
          </thead>
      </table>
